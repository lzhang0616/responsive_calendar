  ...
  render() {
    ...
    return (
      <div className={className}>
        <button className={`btn btn-default ${this.renderButtonClass('day')}`} onClick={showDayView}>
          <span className='hidden-xs'>Day</span>
          <span className='visible-xs'>1</span>
        </button>
        <button className={`btn btn-default ${this.renderButtonClass('week')}`} onClick={showWeekView}>
          <span className='hidden-xs'>Week</span>
          <span className='visible-xs'>7</span>
        </button>
        <button className={`btn btn-default ${this.renderButtonClass('month')}`} onClick={showMonthView}>
